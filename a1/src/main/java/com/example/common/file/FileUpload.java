...
public class FileUpload {
   ...
   public static UUID saveCopyFile(MultipartFile file, String filePath) {
      ...
      File ff = new File("C:/k_digital/second_project/myapp_230508/public/profiles/" + random + "_" + fileName);
   ...
   public static String urlPath(HttpServletRequest request) {
      String saveDirectory = "C:/k_digital/second_project/myapp_230508/public/profiles/";
