...
function ModifyNotice() {
    ...
    const onSubmit2 = async (e) => {
        ...
        await axios.post(`${baseUrl}/modifynotice`, formData, {
            ...
            alert("등록되었습니다"),
            window.location.replace("/editnotice")
        );
    ...
    return <>
        <Container className="d-flex justify-content-center align-items-center" style={{ marginTop: '200px', height: '100vh', width: 1200 }}>
                        ...
                        <Form onSubmit={onSubmit2}>
                            ...
                            <FormGroup>
                                {notices.upload && !imageSrc && (
                                    <img src={"/profiles/" + notices.upload} style={{ width: "100%", height: "300px" }} />
                                )}
                            </FormGroup>
                            <FormGroup>
                                <Label>첨부 이미지</Label>
                            ...
                            {imageSrc && (
                                <FormGroup style={{ width: "600px", height: "400px" }}>
